...
Me gusta cruzar la línea entre creatividad y código para construir soluciones que no solo se vean bien, sino que funcionen.

---

## 🚀 Sobre mí

- 🎨 Diseñador gráfico con experiencia en branding, contenido digital y edición audiovisual  
- 🧠 Entusiasta de la programación y la tecnología, siempre explorando nuevas herramientas  
- ⚙️ Actualmente aprendiendo **Python** para automatizar procesos y crear proyectos propios  
- 🎮 Gamer de corazón: la estrategia y creatividad también se entrenan jugando  
